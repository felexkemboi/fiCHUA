...
<!--                </div>-->
        ...
        <main>
            <div class="relative isolate overflow-hidden bg-gray-900 pb-16 pt-14 sm:pb-20">
                <img src="/storage/images/1.jpg" alt="" class="absolute inset-0 -z-10 h-full w-full" />
                ...
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                        <div class="text-center">
                            <h1 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">fiCHUA anonymously</h1>
                            <p class="mt-6 text-lg leading-8 text-gray-300">Your anonymity is 100% guaranteed. We are not interested in who you are, only what you know, so the more detail you give us the better.</p>
                            <div class="mt-10 flex items-center justify-center gap-x-6">
<!--                                <a href="#" class="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400">Click here to share information</a>-->

                                <router-link class="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400" to="/share">Click here to share information</router-link>
...
const navigation = {
    social: [
        ...
        {
            name: 'Email',
            href: 'mailto:copyright@enaji-afrika',
            icon: defineComponent({
                render: () =>
                    h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
                        h('path', {
                            d: 'M21 2H3a2 2 0 00-2 2v16a2 2 0 002 2h18a2 2 0 002-2V4a2 2 0 00-2-2zM4 6l8 5 8-5v12H4V6z',
                        }),
                    ]),
            }),
        }
...
const faqs = [
    {
        question: "Will I be known some day?",
        answer: "Not even once, and to be assured do not include any personal information in the submission",
    }
]

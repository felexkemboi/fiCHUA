                ...
                <div class="px-4 py-6 sm:p-12">
                    ...
                    <div class="grid  gap-x-6 gap-y-8 sm:grid-cols-12 sm:w-full">
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-2">
                                <textarea id="about" v-model="crime.description" name="about" rows="3" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                            </div>
...
const submitForm = async () => {
    ...
    formData.append("description", crime.value.description);
    ...
    try {
        ...
        const response = await store.addCrime(formData)
